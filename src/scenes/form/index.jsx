...
const initialValues = {
  ...
  address1: "",
  address2: "",
  organizationType: "",  // Add the organizationType to the initial values
};
...
const checkoutSchema = yup.object().shape({
  ...
  organizationType: yup.string().required("required"),  // Add validation for organizationType
});
            ...
            >
              ...
              <FormControl fullWidth variant="filled" sx={{ gridColumn: "span 4" }}>
                ...
                {touched.organizationType && errors.organizationType && (
                  <Box color="error.main" fontSize="0.875rem" mt="5px">
