...
import { fetchStateDistrictWiseReport, saveReport, viewSavedReport, updateSavedReport, clearSelectedSavedReport } from "../../store/reportsSlice";
...
const StateDistrictWiseDispense = () => {
  ...
  ========================= */
        ...
        try {
            if (reportId) {
                ...
                await dispatch(
                    saveReport({
                        ...payload,
                        reportType: "state_district_wise_dispense",
                        summary,
                    })
                ).unwrap();
                // ✅ SUCCESS MESSAGE (UPDATE)
    ...
    const allColumns = [
        ...
        { field: "schoolsCovered", headerName: "No of Schools Covered", flex: 1 },
        { field: "supportedGirls", headerName: "No of Supported Girls", flex: 1 },
        { field: "padsDispensed", headerName: "No of Pads Dispensed", flex: 1 },
        { field: "avgConsumption", headerName: "Average Consumption per Girl", flex: 1 },
    ];
        ...
        <Box m="20px">
            <Box display="flex" alignItems="center" gap={1} mb={2}>
                ...
                {reportId ? (
                    ...
                    <Header
                        title={"State / District Wise Dispense Report"}
                        subtitle={"Compare pad distribution by state and district"}
                    />
                )}
            </Box>
                        ...
                        <>
                            ...
                            <Box height="70vh">
                                {stateDistrictWiseLoading ? (
                                    ...
                                    <DataGrid
                                        rows={data.map((row, i) => ({
                                            id: `${row.state}-${row.schoolDistrict}-${i}`,
                                            ...row,
                                        }))}
...
export default StateDistrictWiseDispense;
