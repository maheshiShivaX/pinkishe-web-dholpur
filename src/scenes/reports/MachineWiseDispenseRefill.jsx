...
import { fetchMachineWiseDispenseRefill, saveReport, viewSavedReport, updateSavedReport, clearSelectedSavedReport } from "../../store/reportsSlice";
...
/* =========================
   OPTIONS
========================= */
const STATE_OPTIONS = ["All States", "Chhattisgarh", "Uttarakhand", "Telangana"];
...
const MachineWiseDispenseRefill = () => {
        ...
        try {
            if (reportId) {
                ...
                await dispatch(
                    saveReport({
                        ...payload,
                        reportType: "machine_wise_dispense_refill",
                        summary,
                    })
                ).unwrap();
                // ✅ SUCCESS MESSAGE (UPDATE)
    ...
    /* =========================
          INPUT STYLE (FIXED FOCUS BORDER)
       ========================= */
    const inputSx = {
    ...
    const allColumns = [
        ...
        { field: "schoolSpocName", headerName: "School Spoc Name", flex: 1.5 },
        { field: "padsDispensed", headerName: "Total Pads Dispensed", flex: 1 },
        { field: "lastPadDispenseDate", headerName: "Last Dispense Date", flex: 1.5 },
        { field: "totalRefill", headerName: "Total Refill", flex: 1 },
        { field: "lastRefillDate", headerName: "Last Refill Date", flex: 1.5 },
    ];
        ...
        <Box m="20px">
            <Box display="flex" alignItems="center" gap={1} mb={2}>
                ...
                {reportId ? (
                    ...
                    <Header
                        title={"Machine Wise Dispense & Refill"}
                        subtitle={"Machine-wise dispense and refill tracking"}
                    />
                )}
            </Box>
                        ...
                        <>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <MenuItem value="dispensed">Dispense through Machine</MenuItem>
                                    <MenuItem value="manual">Manual Distribution</MenuItem>
                                </TextField>
                            </Box>
                                    ...
                                    <DataGrid
                                        ...
                                        sx={{
                                            ...
                                            "& .MuiDataGrid-iconButtonContainer svg": {
                                                color: "#fff !important",
                                                opacity: 1, // ✅ Always show sort icon
                                            },
                            ...
                            {summary && (
                                ...
                                >
                                    <Typography fontWeight="bold" mb="15px">
                                        Summary (As per Include Selections)
                                    </Typography>

                                    <Typography mb="15px">Period: {summary.period}</Typography>
                                    <Typography mb="15px">Number of Days: {summary.numberOfDays}</Typography>
                                    <Typography mb="15px">Number of States: {summary.numberOfStates}</Typography>
                                    <Typography mb="15px">Number of Districts: {summary.numberOfDistricts}</Typography>
                                    <Typography mb="15px">Number of Machines Installed: {summary.numberOfMachinesInstalled}</Typography>
                                    <Typography mb="15px">Number of Schools Covered: {summary.numberOfSchoolsCovered}</Typography>
                                    <Typography mb="15px">Number of Supported Girls: {summary.numberOfSupportedGirls}</Typography>
                                    <Typography mb="15px">Number of Pads Dispensed: {summary.numberOfPadsDispensed}</Typography>
                                    <Typography mb="15px">Average Consumption per Girl: {summary.averageConsumptionPerGirl}</Typography>

                                    {/* last item me margin optional */}
                                    <Typography>Total Refills: {summary.totalRefills}</Typography>
                                </Box>
                            )}
...
export default MachineWiseDispenseRefill;
