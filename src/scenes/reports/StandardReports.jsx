...
const StandardReports = () => {
  ...
  const {
    ...
    stateDistrictWiseReport: {
      ...
      summary: stateDistrictSummary = null
    } = {},
  ...
  const columns = [
    ...
    },
    {
      ...
      flex: 1,
      valueGetter: (params) =>
        params.row.report_name || params.row.reportName || "-"
    },
    {
      field: "owner_name",
      headerName: "Owner",
      flex: 1,
      valueGetter: (params) =>
        params.row.owner_name || params.row.ownerName || "-"
    },
    {
      field: "created_at",
  ...
  return (
    <>
      <Box m="20px">
        <Header title="Standard Reports" subtitle="View reports" />
        ...
        <Box height="70vh">
          {standardReportsLoading ? (
            ...
            <DataGrid
              ...
              localeText={{
                noRowsLabel: "No standard reports found"
              }}
            />
          )}
        </Box>
            ...
            >
              ...
              {pdfSummary && Object.keys(pdfSummary).length > 0 && (
                <Box mt={3}>
                  ...
                  {Object.entries(pdfSummary).map(([key, value]) => (
                    <Box
                      key={key}
                      sx={{
                        display: "flex",
                    ...
                    >
                      ...
                      <Typography>{formatCellValue(value)}</Typography>
                    </Box>
                  ))}
                </Box>
              )}
